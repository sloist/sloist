...
export default function WriteEditor({ editorId, isAdmin, userId, isStaff, onClose, onSaved, editItem }) {
  ...
  const textareaStyle = { ...inputStyle, resize: "none", minHeight: mob ? 100 : 140, lineHeight: 2 };
  ...
  return (
    <div style={{ minHeight: "100vh", background: S.bg, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ maxWidth: mob ? 600 : 900, margin: "0 auto", width: "100%", padding: mob ? "20px 16px" : "32px 36px", display: mob ? "block" : "flex", gap: mob ? 0 : 40 }}>
        ...
        <div style={{ flex: mob ? undefined : 1, minWidth: 0 }}>
          ...
          {/* 썸네일 비율 */}
          <div style={{ marginBottom: mob ? g : 0 }}>
      ...
      {/* ─── 발행 버튼 ─── */}
      <div style={{ maxWidth: mob ? 600 : 900, margin: "0 auto", width: "100%", padding: mob ? "0 16px 48px" : "0 36px 48px" }}>
